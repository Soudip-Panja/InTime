...
export default function StrategicTech() {
  ...
  useEffect(() => {
    ...
    challengeRefs.current.forEach((card, index) => {
      if (card) {
        gsap.fromTo(card,
          { opacity: 0, y: 40 },
          {
      ...
      if (banner) {
        gsap.fromTo(banner,
          { opacity: 0, scale: 0.95 },
          {
            ...
            scrollTrigger: { trigger: banner, start: "top 85%", toggleActions: "play none none reverse" }
          }
        );
      }
    });
  ...
  return (
    <div className="page-wrapper" ref={contentRef}>
          ...
          <div className="container" style={{ position: 'relative', zIndex: 2 }}>
            <div className="why-header text-center mx-auto" style={{ maxWidth: '900px' }} ref={heroRef}>
              ...
              <div className="trusted-stats d-flex gap-5 mt-5 pt-3 flex-wrap justify-content-center">
                <div>
                  <NumberCounter end={95} suffix="%" className="stat-number" style={{ fontSize: '2.5rem' }} />
                  <p className="hero-label mb-0 mt-2" style={{ fontSize: '0.8rem', opacity: 0.8 }}>CLIENT RETENTION</p>
                </div>
                <div>
                  <NumberCounter end={48} suffix="hrs" className="stat-number" style={{ fontSize: '2.5rem' }} />
                  <p className="hero-label mb-0 mt-2" style={{ fontSize: '0.8rem', opacity: 0.8 }}>AVERAGE DEPLOYMENT</p>
                </div>
                <div>
                  <NumberCounter end={500} suffix="+" className="stat-number gradient-text" style={{ fontSize: '2.5rem' }} />
      ...
      <section className="st-section st-section-dark">
        <div className="container">
          ...
          <div className="row g-4 justify-content-center">
            <div className="col-12 col-md-6 col-lg-4" ref={el => challengeRefs.current[0] = el}>
            ...
            <div className="col-12 col-md-6 col-lg-4" ref={el => challengeRefs.current[1] = el}>
              <div className="st-card torch-glow-card flex-row align-items-center gap-3">
            ...
            <div className="col-12 col-md-6 col-lg-4" ref={el => challengeRefs.current[2] = el}>
              <div className="st-card torch-glow-card flex-row align-items-center gap-3">
            ...
            <div className="col-12 col-md-6 col-lg-4" ref={el => challengeRefs.current[3] = el}>
              <div className="st-card torch-glow-card flex-row align-items-center gap-3">
            ...
            <div className="col-12 col-md-6 col-lg-4" ref={el => challengeRefs.current[4] = el}>
              <div className="st-card torch-glow-card flex-row align-items-center gap-3">
      ...
      <section className="st-section st-section-alt">
        <div className="container">
          ...
          <div className="row g-4">
            <div className="col-12 col-lg-6" ref={el => capabilityRefs.current[0] = el}>
            ...
            <div className="col-12 col-lg-6" ref={el => capabilityRefs.current[1] = el}>
              <div className="st-card torch-glow-card">
                <div className="d-flex align-items-center mb-3">
            ...
            <div className="col-12 col-lg-6" ref={el => capabilityRefs.current[2] = el}>
              <div className="st-card torch-glow-card">
                <div className="d-flex align-items-center mb-3">
            ...
            <div className="col-12 col-lg-6" ref={el => capabilityRefs.current[3] = el}>
              <div className="st-card torch-glow-card">
                <div className="d-flex align-items-center mb-3">
      ...
      <section className="st-section st-section-dark">
        <div className="container">
          ...
          <div className="row g-4 justify-content-center text-center">
            <div className="col-12 col-md-6 col-lg-4" ref={el => advantageRefs.current[0] = el}>
            ...
            <div className="col-12 col-md-6 col-lg-4" ref={el => advantageRefs.current[1] = el}>
              <div className="st-card torch-glow-card align-items-center">
            ...
            <div className="col-12 col-md-6 col-lg-4" ref={el => advantageRefs.current[2] = el}>
              <div className="st-card torch-glow-card align-items-center">
            ...
            <div className="col-12 col-md-6 col-lg-4" ref={el => advantageRefs.current[3] = el}>
              <div className="st-card torch-glow-card align-items-center">
            ...
            <div className="col-12 col-md-6 col-lg-4" ref={el => advantageRefs.current[4] = el}>
              <div className="st-card torch-glow-card align-items-center">
          ...
          <div className="st-banner" ref={el => bannerRefs.current[0] = el}>
      ...
      <section className="st-section st-section-alt" style={{ paddingBottom: '8rem' }}>
        <div className="container">
          <div className="st-banner" style={{ marginTop: 0, padding: '4rem 2rem' }} ref={el => bannerRefs.current[1] = el}>
